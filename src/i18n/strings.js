...
const STRINGS = {
  ...
  'es-ES': {
    ...
    reader: {
      ...
      cleanJp: '🧹 Limpiar japonés',
      cleanJpTitle: 'Limpiar texto japonés que se haya podido colar en la traducción',
    },
    cleanJp: {
      title: 'Limpiar japonés colado',
      subtitle: (num, lang) => `Capítulo ${num} · ${lang}`,
      close: 'Cerrar',
      detectedSummary: (chars, runs) => `Detectados ${chars} carácter(es) japonés(es) en ${runs} tramo(s).`,
      noneDetected: 'No se ha detectado ningún carácter japonés. La traducción está limpia.',
      runsPreviewNote: (visible, total) => `Mostrando ${visible} de ${total} párrafo(s) afectados`,
      modeAi: 'Pedir a la IA',
      modeManual: 'Editar manualmente',
      promptTitle: '1. Prompt para la IA',
      copyPrompt: 'Copiar prompt',
      copied: 'Copiado ✓',
      pasteTitle: '2. Pega aquí la traducción corregida',
      pastePlaceholder: 'Pega aquí el texto corregido por la IA…',
      applyToEditor: 'Pasar al editor manual ↓',
      aiHelp: 'La IA devolverá solo el texto corregido, sin comentarios. Al pulsar Guardar se sobrescribirá el archivo de traducción (el estado del capítulo se mantiene).',
      manualHelp: 'Edita directamente el texto. Lo que guardes aquí reemplazará el archivo de traducción actual.',
      cancel: 'Cancelar',
      save: 'Guardar traducción corregida',
    },
    status: {
      novel: {
        NEW: 'Nueva',
  ...
  'ca-ES': {
    ...
    reader: {
      ...
      cleanJp: '🧹 Netejar japonès',
      cleanJpTitle: 'Netejar text japonès que s\'hagi pogut colar a la traducció',
    },
    cleanJp: {
      title: 'Netejar japonès colat',
      subtitle: (num, lang) => `Capítol ${num} · ${lang}`,
      close: 'Tancar',
      detectedSummary: (chars, runs) => `Detectats ${chars} caràcter(s) japonès(os) en ${runs} tram(s).`,
      noneDetected: 'No s\'ha detectat cap caràcter japonès. La traducció està neta.',
      runsPreviewNote: (visible, total) => `Mostrant ${visible} de ${total} paràgraf(s) afectats`,
      modeAi: 'Demanar a la IA',
      modeManual: 'Editar manualment',
      promptTitle: '1. Prompt per a la IA',
      copyPrompt: 'Copia el prompt',
      copied: 'Copiat ✓',
      pasteTitle: '2. Enganxa aquí la traducció corregida',
      pastePlaceholder: 'Enganxa aquí el text corregit per la IA…',
      applyToEditor: 'Passar a l\'editor manual ↓',
      aiHelp: 'La IA tornarà només el text corregit, sense comentaris. En prémer Desar se sobreescriurà el fitxer de traducció (l\'estat del capítol es manté).',
      manualHelp: 'Edita directament el text. El que desis aquí substituirà el fitxer de traducció actual.',
      cancel: 'Cancel·lar',
      save: 'Desar traducció corregida',
    },
    status: {
      novel: {
        NEW: 'Nova',
